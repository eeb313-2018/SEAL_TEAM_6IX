...
birds1 <- birds[, c(1:7, 18, 15:17, 8:14)]
...
## Combine 4 datasets: bird abundance, vehicle data, weather, and route details
...
write.csv(expanded_df2, "Swallows only - Ontario Bird Data Expanded.csv")
```
